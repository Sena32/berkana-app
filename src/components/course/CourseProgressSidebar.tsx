    ...
    <div className="bg-white rounded-lg border border-gray-200 p-6 space-y-6">
      ...
      <div>
        ...
        <div className="flex items-center gap-1">
          ...
          <span className="text-sm text-gray-600">{course.rating} ({course.reviews || 0} Avaliações)</span>
        </div>
      </div>
      ...
      {!isPublic && studentEnrollment && course.progress && (
        <div>
          <div className="flex justify-between text-sm text-gray-600 mb-2">
            <span>{course.progress.completed}/{course.progress.total || 0} Módulos</span>
      ...
      <div className="space-y-3 pt-4 border-t border-gray-200">
        ...
        {!isPublic && !studentEnrollment && course.level === 'PAGO' && (
          <div className="flex flex-col gap-2">
            <h3 className="font-medium text-gray-900">{formatCurrency(Number(course.price))}</h3>
